                                                                        ...
                                                                        <label for="inputCard" class="form-label">
                                                                            ...
                                                                            <div class="input-group mb-3">
                                                                                <span class="input-group-text" id="basic-addon1">
                                                                                    ...
                                                                                    <input
                                                                                    type="text" id="inputCard" class="form-control" placeholder="XXXX-XXXX-XXXX-XXXX"
                                                                                    aria-label="Username"
                                                                                                                         ...
                                                                                                                         <select id="inputState" class="form-select">
                                                                                                                            ...
                                                                                                                            <div class="col-md-2">
                                                                                                                                <label for="inputZip" class="form-label">
                                                                                                                                    ...
                                                                                                                                    <div class="col-12">
                                                                                                                                        <button
                                                                                                                                        type="button" class="btn btn-success" onClick={() => handleSubmitButton()}
                                                                                                                                        >
                                                                                                                                            {" "}
                                                                                                                                            ...
                                                                                                                                            {showConfirmation && (
                                                                                                                                                <div class="card" style={{ width: 18 + "rem" }}>
                                                                                                                                                    <div class="card-body">
                                                                                                                                                        ...
                                                                                                                                                        <a href="" onClick="location.reload()" class="btn btn-secondary"//onclick vs onClick?
                                                                                                                                                        >
                                                                                                                                                            {" "}
